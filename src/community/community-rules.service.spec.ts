...
/**
 * La autorización por rol (OWNER o MODERATOR) ya no vive aquí: la resuelve
 * CommunityRoleGuard antes de llegar al controller (ver
 * community-role.guard.spec.ts). Estos tests cubren solo lo que sigue siendo
 * responsabilidad del service una vez que un actor ya fue autorizado.
 */
